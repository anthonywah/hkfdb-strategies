...
def backtest(para_combination):
    ...
    if cross_direction == 'cross_over':
        df['trade_logic'] = (df['cbbc_mak_cap_ratio'] > ratio_threshold * 0.01) & \
                            (df['cbbc_mak_cap_ratio-1'] <= ratio_threshold * 0.01)
...
if __name__ == '__main__':
    ...
    para_dict = {
        ...
        'ratio_threshold'        : [10, 20, 30, 40, 50, 60, 70, 80, 90],
    }
